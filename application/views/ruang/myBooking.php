      ...
      <table class="table table-responsive table-striped">
        <thead class="bg-info text-white">
          ...
          <tr>
            ...
            <th style="width:10px;">No Telpon</th>
            <th>Status</th>
            <th width="10%">Deadline</th>
          </tr>
        </thead>
        <tbody class="table table-hover  table-bordered">
          <?php foreach ($proses['peminjaman'] as $pp) : ?>
            <tr>
              ...
              <td>
                <div class="btn btn-sm <?= statusHelpers($pp['id_status'])['style'] ?>">
...
<!-- <div>
  ...
  $id = $pp->id_status;
  if ( $id == 5) {
    echo '<a href="'.base_url('validasi/confirm/') . $pp->id;'" class="btn btn-primary btn-sm">Confirm</a>';
    echo '<a href="'.base_url('validasi/selesai/') . $pp->id;'" class="btn btn-success btn-sm mt-2">Selesai</a>';
  } else {
    echo '<a href="'.base_url('validasi/cancel/') . $pp->id;'" class="btn btn-danger btn-sm mt-2">Cancel</a>';
  }
  ?>
</div> -->
