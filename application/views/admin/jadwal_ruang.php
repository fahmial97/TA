 ...
 <div class="container">
     ...
     <div class="card header ngecek-libur p-4">
             ...
             <form method="post" action="<?= base_url('admin/updateWaktuRuang') ?>">
                 ...
                 <div class="card shadow-sm mb-5">
                     <div class="row no-gutters m-1 text-center">
                         ...
                         <div class="col-6 col-md-1 p-md-2">
                             <h6 class=" font-weight-bold">Libur</h6>
                             <div class="custom-control custom-checkbox">
                                 <input type="checkbox" class="custom-control-input yang-dicek" data-id="<?=$jam->id ?>" value="<?= $jam->libur ?>" id="customCheck<?= $jam->id ?>" <?php if($jam->libur == 1){echo 'checked';} ?> >
                                 <label class="custom-control-label" for="customCheck<?= $jam->id ?>"></label>
                             </div>
                         </div>
                     </div>
                 </div>
